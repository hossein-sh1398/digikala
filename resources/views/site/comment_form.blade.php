...
@section('content')
    ...
    @else
        ...
        <div class="row content_box" @if(sizeof($score)==0) style="background:#fff;opacity:0.5;cursor: not-allowed;" @endif>
                ...
                <form action="{{ url('site/add_comment') }}" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input @if(sizeof($score)==0) disabled="disabled" @endif type="text"  class="form-control" name="subject">
                        </div>

                        <div style="clear:both"></div>
                        <div class="form-group">
                            <p style="color:green;padding-top: 10px;">نقاط قوت</p>
                            <input @if(sizeof($score)==0) disabled="disabled" @endif  type="text"  class="form-control advantages" name="advantages[]">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" style="margin-top:75px;">
                            <p style="color:red;padding-top: 10px;">نقاط ضعف</p>
                            <input @if(sizeof($score)==0) disabled="disabled" @endif type="text"  class="form-control disadvantages" name="disadvantages[]">
            ...
            <div class="col-md-12" id="comment_text_box">
                <div class="form-group" style="padding-right:15px;padding-top: 20px;">
                    ...
                    <textarea @if(sizeof($score)==0) disabled="disabled" @endif name="comment_text"></textarea>
                </div>
